...
MODELS_DIR = '/home/niuhao/project/ASC/RGAT-ABSA_utils/'
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='/home/niuhao/project/ASC/RGAT-ABSA_V1/data/MAMS-ATSA/raw',
